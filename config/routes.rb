Musica::Application.routes.draw do
  ...
  resources :line_items, only: [:create,:destroy,:index]
  ...
  get '/artistas/letra/:letra', to: 'artistas#letra', as: 'show_artista_letra'


  get '/categorias', to: 'categorias#index'
  get '/categoria/:category', to: 'categorias#show', as: 'show_categoria'
